// ------------------------------------------------
// Project Name: SaaSKit Coming Soon Experience
// Description: Customized launch page interactions for the SaaSKit monorepo
// Adapted from: Ramio template by mix_design
// Maintainer: SaaSKit Team
// ------------------------------------------------
...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  var releaseDateISO = window.__SAASKIT_RELEASE_DATE || "2026-01-01T00:00:00.000Z";
  var releaseDate = new Date(releaseDateISO);
  var target = $.countdown.UTCDate(
    0,
    releaseDate.getUTCFullYear(),
    releaseDate.getUTCMonth() + 1,
    releaseDate.getUTCDate(),
    releaseDate.getUTCHours(),
    releaseDate.getUTCMinutes(),
    releaseDate.getUTCSeconds()
  );
  $('#countdown').countdown({until: target, format: 'D'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
